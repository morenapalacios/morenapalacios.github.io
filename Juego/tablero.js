...
function inicio(){
    buscaminas.numFilas = 20;
    buscaminas.numColumnas = 20;
    buscaminas.numMinasTotales = 24;
...
/* Botones Menu ----------------------------------------------------------------------*/
 ...
 /* Menú Boton Reiniciar */

 /* muestra div cartel confirmación */
 function showReinicio() {
    ...
    document.getElementById('btnInx').disabled = false;

    if (document.getElementById('reiniciar-back').style.display !== "none") {
        document.getElementById('btnR').disabled = true;
    } else {
    document.getElementById('btnR').disabled = true;
    document.getElementById('reiniciar-back').style.display = "block"
    }
 }

 /* cierra div cartel confirmación*/
 function closeReinicio() {
    document.getElementById('reiniciar-back').style.display = "none";
    document.getElementById('btnR').disabled = false;
};

/* Menú Boton Instrucciones */
 ...
 function showInstructions() {
    ...
    if (document.getElementById('instrucciones-back').style.display !== "none") {
    document.getElementById('btnI').disabled = true;
    } else {
    document.getElementById('btnI').disabled = true;
    document.getElementById('instrucciones-back').style.display = "block"
    }
 }

  /* cierra div cartel confirmación*/
function closeInstrucciones() {
    document.getElementById('instrucciones-back').style.display = "none";
    document.getElementById('btnI').disabled = false;
};
...
/* Menú Boton Audio */
 ...
 function showAudio() {
    ...
    if (document.getElementById('audio-back').style.display !== "none") {
    document.getElementById('btnA').disabled = true;
    } else {
    document.getElementById('btnA').disabled = true;
    document.getElementById('audio-back').style.display = "block"
    }
 }

  /* cierra div cartel confirmación*/
function closeAudio() {
    document.getElementById('audio-back').style.display = "none";
    document.getElementById('btnA').disabled = false;
};
...
/* Menú Boton Inicio */
 ...
 function showInicio() {
    ...
    if (document.getElementById('inicio-back').style.display !== "none") {
    document.getElementById('btnInx').disabled = true;
    } else {
    document.getElementById('btnInx').disabled = true;
    document.getElementById('inicio-back').style.display = "block"
    }
 }

  /* cierra div cartel confirmación*/
function closeInicio() {
    document.getElementById('inicio-back').style.display = "none";
    document.getElementById('btnInx').disabled = false;
};
...
function setBar() {
    ...
    audio.volume = slider.value / 100; // Convert the range to a value between 0 and 1
}
